...
import { IconLoader2, IconAlertTriangle, IconAlertCircle, IconAppWindow, IconGitBranch } from '@tabler/icons';
...
const CollectionItemIcon = ({ item }) => {
  ...
  if (item?.type === 'flow') {
    return <IconGitBranch className="w-fit mr-2" size={16} strokeWidth={1.5} />;
  }
